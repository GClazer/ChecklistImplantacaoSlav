...
import FormCheckList from './components/forms/FormCheckList.vue'
import FormUser from './components/forms/FormUser.vue';
import FormTask from './components/forms/FormTask.vue';
import FormSearch from './components/forms/FormSearch.vue';
import DeleteButton from './components/forms/buttons/DeleteButton.vue';

app.component('nav-bar', NavBar);
app.component('form-checklist', FormCheckList);
app.component('form-user', FormUser);
app.component('form-task', FormTask);
